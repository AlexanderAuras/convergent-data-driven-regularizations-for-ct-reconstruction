...
class DeterministicMultivariateNormal(Distribution):
    r"""
    ...
    def __init__(self, loc, covariance_matrix=None, precision_matrix=None, scale_tril=None, validate_args=None):
        ...
        super(DeterministicMultivariateNormal, self).__init__(batch_shape, event_shape, validate_args=validate_args)
    ...
    def expand(self, batch_shape, _instance=None):
        new = self._get_checked_instance(DeterministicMultivariateNormal, _instance)
        ...
        super(DeterministicMultivariateNormal, new).__init__(batch_shape,
                                                self.event_shape,
                                                validate_args=False)
    ...
    def rsample(self, sample_shape=torch.Size(), generator=None):
        ...
        if torch._C._get_tracing_state():
            ...
            eps = torch.normal(torch.zeros(shape, dtype=self.loc.dtype, device=self.loc.device), torch.ones(shape, dtype=self.loc.dtype, device=self.loc.device), generator=gen)
        else:
            eps = torch.empty(shape, dtype=self.loc.dtype, device=self.loc.device).normal_(generator=gen)
